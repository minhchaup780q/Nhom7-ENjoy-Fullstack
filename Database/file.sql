...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	...
	(54, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+have+got+black+hair&type=2', 'I have got black hair.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/hair.webp', 'FLASHCARD', 'hair', 'Tôi có một mái tóc.'),
	(55, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+have+nice+teeth&type=2', 'I have nice teeth.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/teeth.webp', 'FLASHCARD', 'teeth', 'Tôi có một hàm răng đẹp.');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	...
	(548, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+have+you+got&type=2', 'What have you got?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/teeth.webp', 'QUIZ', 'teeth', 'Bạn có gì?');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	...
	(59, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+have+got+black+hair&type=2', 'I have got black [hair].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/hair.webp', 'FILL_IN_BLANK', 'hair', 'Tôi có một mái tóc.'),
	...
	(65, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+have+nice+teeth&type=2', 'I have nice [teeth].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/teeth.webp', 'FILL_IN_BLANK', 'teeth', 'Tôi có một hàm răng đẹp.');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	...
	(124, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+can+see+a+zebra&type=2', 'I can see a zebra.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/zebra.webp', 'FLASHCARD', '	', 'Tôi có thể nhìn thấy một con ngựa vằn.');
...
INSERT INTO `session_item_mappings` (`create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `order_index`, `session_id`, `session_item_id`) VALUES
	...
	(NOW(), NULL, b'0', NOW(), NULL, 2, 16, 50),
	(NOW(), NULL, b'0', NOW(), NULL, 3, 16, 51),
	(NOW(), NULL, b'0', NOW(), NULL, 4, 16, 52),
	(NOW(), NULL, b'0', NOW(), NULL, 5, 16, 53),
	(NOW(), NULL, b'0', NOW(), NULL, 6, 16, 54),
	(NOW(), NULL, b'0', NOW(), NULL, 7, 16, 55),
	-- Session 17 (LISTENING - Body Part 1)
	(NOW(), NULL, b'0', NOW(), NULL, 1, 17, 48),
	(NOW(), NULL, b'0', NOW(), NULL, 2, 17, 50),
	(NOW(), NULL, b'0', NOW(), NULL, 3, 17, 51),
	(NOW(), NULL, b'0', NOW(), NULL, 4, 17, 52),
	(NOW(), NULL, b'0', NOW(), NULL, 5, 17, 53),
	(NOW(), NULL, b'0', NOW(), NULL, 6, 17, 54),
	(NOW(), NULL, b'0', NOW(), NULL, 7, 17, 55),
	-- Session 18 (SPEAKING - Body Part 1)
	(NOW(), NULL, b'0', NOW(), NULL, 1, 18, 48),
	(NOW(), NULL, b'0', NOW(), NULL, 2, 18, 50),
	(NOW(), NULL, b'0', NOW(), NULL, 3, 18, 51),
	(NOW(), NULL, b'0', NOW(), NULL, 4, 18, 52),
	(NOW(), NULL, b'0', NOW(), NULL, 5, 18, 53),
	(NOW(), NULL, b'0', NOW(), NULL, 6, 18, 54),
	(NOW(), NULL, b'0', NOW(), NULL, 7, 18, 55),
	-- Session 19 (WORD_RECOGNITION - Body Part 1)
	(NOW(), NULL, b'0', NOW(), NULL, 1, 19, 57),
	(NOW(), NULL, b'0', NOW(), NULL, 2, 19, 543),
	(NOW(), NULL, b'0', NOW(), NULL, 3, 19, 544),
	(NOW(), NULL, b'0', NOW(), NULL, 4, 19, 545),
	(NOW(), NULL, b'0', NOW(), NULL, 5, 19, 546),
	(NOW(), NULL, b'0', NOW(), NULL, 6, 19, 547),
	(NOW(), NULL, b'0', NOW(), NULL, 7, 19, 548),
	-- Session 20 (GAMIFIED_REVIEW - Body Part 1)
	(NOW(), NULL, b'0', NOW(), NULL, 1, 20, 58),
	(NOW(), NULL, b'0', NOW(), NULL, 2, 20, 59),
	(NOW(), NULL, b'0', NOW(), NULL, 3, 20, 61),
	(NOW(), NULL, b'0', NOW(), NULL, 4, 20, 62),
	(NOW(), NULL, b'0', NOW(), NULL, 5, 20, 63),
	(NOW(), NULL, b'0', NOW(), NULL, 6, 20, 64),
	(NOW(), NULL, b'0', NOW(), NULL, 7, 20, 65),
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(207, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+am+in+the+house&type=2', 'I am in the house.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/house.webp', 'FLASHCARD', 'house', 'Tôi đang ở trong ngôi nhà.'),
	(208, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+am+in+the+flat&type=2', 'I am in the flat.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/flat.webp', 'FLASHCARD', 'flat', 'Tôi đang ở trong căn hộ.'),
	...
	(210, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+am+in+the+kitchen&type=2', 'I am in the kitchen.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/kitchen.webp', 'FLASHCARD', 'kitchen', 'Tôi đang ở trong bếp.'),
	(211, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+am+in+the+bedroom&type=2', 'I am in the bedroom.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/bedroom.webp', 'FLASHCARD', 'bedroom', 'Tôi đang ở trong phòng ngủ.'),
	(212, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+am+in+the+bathroom&type=2', 'I am in the bathroom.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/bathroom.webp', 'FLASHCARD', 'bathroom', 'Tôi đang ở trong phòng tắm.'),
	(213, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+am+in+the+living+room&type=2', 'I am in the living room.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/living-room.webp', 'FLASHCARD', 'living room', 'Tôi đang ở trong phòng khách.'),
	(214, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+am+in+the+dining+room&type=2', 'I am in the dining room.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/dining-room.webp', 'FLASHCARD', 'dining room', 'Tôi đang ở trong phòng ăn.'),
	(215, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+am+in+the+hall&type=2', 'I am in the hall.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/hall.webp', 'FLASHCARD', 'hall', 'Tôi đang ở trong hành lang.'),
	(216, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+am+in+the+garden&type=2', 'I am in the garden.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/garden.webp', 'FLASHCARD', 'garden', 'Tôi đang ở trong vườn.');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(217, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=Where+are+you&type=2', 'Where are you?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/house.webp', 'QUIZ', 'house', 'Bạn đang ở đâu?'),
	(606, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=Where+are+you&type=2', 'Where are you?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/flat.webp', 'QUIZ', 'flat', 'Bạn đang ở đâu?'),
	...
	(608, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=Where+are+you&type=2', 'Where are you?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/kitchen.webp', 'QUIZ', 'kitchen', 'Bạn đang ở đâu?'),
	(609, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=Where+are+you&type=2', 'Where are you?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/bedroom.webp', 'QUIZ', 'bedroom', 'Bạn đang ở đâu?'),
	(610, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=Where+are+you&type=2', 'Where are you?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/bathroom.webp', 'QUIZ', 'bathroom', 'Bạn đang ở đâu?'),
	(611, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=Where+are+you&type=2', 'Where are you?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/living-room.webp', 'QUIZ', 'living room', 'Bạn đang ở đâu?'),
	(612, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=Where+are+you&type=2', 'Where are you?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/dining-room.webp', 'QUIZ', 'dining room', 'Bạn đang ở đâu?'),
	(613, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=Where+are+you&type=2', 'Where are you?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/hall.webp', 'QUIZ', 'hall', 'Bạn đang ở đâu?'),
	(614, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=Where+are+you&type=2', 'Where are you?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/garden.webp', 'QUIZ', 'garden', 'Bạn đang ở đâu?');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(218, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+am+in+the+house&type=2', 'I am in the [house].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/house.webp', 'FILL_IN_BLANK', 'house', 'Tôi đang ở trong ngôi nhà.'),
	(219, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+am+in+the+flat&type=2', 'I am in the [flat].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/flat.webp', 'FILL_IN_BLANK', 'flat', 'Tôi đang ở trong căn hộ.'),
	...
	(221, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+am+in+the+kitchen&type=2', 'I am in the [kitchen].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/kitchen.webp', 'FILL_IN_BLANK', 'kitchen', 'Tôi đang ở trong bếp.'),
	(222, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+am+in+the+bedroom&type=2', 'I am in the [bedroom].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/bedroom.webp', 'FILL_IN_BLANK', 'bedroom', 'Tôi đang ở trong phòng ngủ.'),
	(223, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+am+in+the+bathroom&type=2', 'I am in the [bathroom].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/bathroom.webp', 'FILL_IN_BLANK', 'bathroom', 'Tôi đang ở trong phòng tắm.'),
	(224, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+am+in+the+living+room&type=2', 'I am in the [living room].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/living-room.webp', 'FILL_IN_BLANK', 'living room', 'Tôi đang ở trong phòng khách.'),
	(225, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+am+in+the+dining+room&type=2', 'I am in the [dining room].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/dining-room.webp', 'FILL_IN_BLANK', 'dining room', 'Tôi đang ở trong phòng ăn.'),
	(226, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+am+in+the+hall&type=2', 'I am in the [hall].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/hall.webp', 'FILL_IN_BLANK', 'hall', 'Tôi đang ở trong hành lang.'),
	(227, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+am+in+the+garden&type=2', 'I am in the [garden].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/garden.webp', 'FILL_IN_BLANK', 'garden', 'Tôi đang ở trong vườn.');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(228, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+table&type=2', 'There is a table.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/table.webp', 'FLASHCARD', 'table', 'Có một cái bàn.'),
	(229, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+chair&type=2', 'There is a chair.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/chair.webp', 'FLASHCARD', 'chair', 'Có một cái ghế.'),
	(230, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+desk&type=2', 'There is a desk.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/desk.webp', 'FLASHCARD', 'desk', 'Có một cái bàn làm việc.'),
	(231, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+bed&type=2', 'There is a bed.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/bed.webp', 'FLASHCARD', 'bed', 'Có một cái giường.'),
	(232, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+sofa&type=2', 'There is a sofa.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/sofa.webp', 'FLASHCARD', 'sofa', 'Có một cái ghế sofa.'),
	(233, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+an+armchair&type=2', 'There is an armchair.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/armchair.webp', 'FLASHCARD', 'armchair', 'Có một cái ghế bành.'),
	(234, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+bookcase&type=2', 'There is a bookcase.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/bookcase.webp', 'FLASHCARD', 'bookcase', 'Có một cái tủ sách.'),
	(235, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+cupboard&type=2', 'There is a cupboard.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/cupboard.webp', 'FLASHCARD', 'cupboard', 'Có một cái tủ chạn.'),
	(236, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+mirror&type=2', 'There is a mirror.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/mirror.webp', 'FLASHCARD', 'mirror', 'Có một cái gương.');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(237, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+there&type=2', 'What is there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/table.webp', 'QUIZ', 'table', 'Có gì ở đó?'),
	(615, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+there&type=2', 'What is there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/chair.webp', 'QUIZ', 'chair', 'Có gì ở đó?'),
	(616, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+there&type=2', 'What is there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/desk.webp', 'QUIZ', 'desk', 'Có gì ở đó?'),
	(617, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+there&type=2', 'What is there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/bed.webp', 'QUIZ', 'bed', 'Có gì ở đó?'),
	(618, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+there&type=2', 'What is there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/sofa.webp', 'QUIZ', 'sofa', 'Có gì ở đó?'),
	(619, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+there&type=2', 'What is there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/armchair.webp', 'QUIZ', 'armchair', 'Có gì ở đó?'),
	(620, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+there&type=2', 'What is there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/bookcase.webp', 'QUIZ', 'bookcase', 'Có gì ở đó?'),
	(621, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+there&type=2', 'What is there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/cupboard.webp', 'QUIZ', 'cupboard', 'Có gì ở đó?'),
	(622, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+there&type=2', 'What is there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/mirror.webp', 'QUIZ', 'mirror', 'Có gì ở đó?');

INSERT INTO `sessions` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `badge_id`, `description`, `order_index`, `session_type`, `status`, `title`, `part_id`) VALUES
	(75, NOW(), NULL, b'0', NOW(), NULL, NULL, 'Review furniture vocabulary with games!', 5, 'GAMIFIED_REVIEW', 'LOCK', 'Furniture Adventure 1', 16);

INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(238, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+table&type=2', 'There is a [table].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/table.webp', 'FILL_IN_BLANK', 'table', 'Có một cái bàn.'),
	(239, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+chair&type=2', 'There is a [chair].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/chair.webp', 'FILL_IN_BLANK', 'chair', 'Có một cái ghế.'),
	(240, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+desk&type=2', 'There is a [desk].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/desk.webp', 'FILL_IN_BLANK', 'desk', 'Có một cái bàn làm việc.'),
	(241, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+bed&type=2', 'There is a [bed].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/bed.webp', 'FILL_IN_BLANK', 'bed', 'Có một cái giường.'),
	(242, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+sofa&type=2', 'There is a [sofa].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/sofa.webp', 'FILL_IN_BLANK', 'sofa', 'Có một cái ghế sofa.'),
	(243, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+an+armchair&type=2', 'There is an [armchair].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/armchair.webp', 'FILL_IN_BLANK', 'armchair', 'Có một cái ghế bành.'),
	(244, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+bookcase&type=2', 'There is a [bookcase].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/bookcase.webp', 'FILL_IN_BLANK', 'bookcase', 'Có một cái tủ sách.'),
	(245, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+cupboard&type=2', 'There is a [cupboard].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/cupboard.webp', 'FILL_IN_BLANK', 'cupboard', 'Có một cái tủ chạn.'),
	(246, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+mirror&type=2', 'There is a [mirror].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/mirror.webp', 'FILL_IN_BLANK', 'mirror', 'Có một cái gương.');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(247, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+lamp&type=2', 'There is a lamp.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/lamp.webp', 'FLASHCARD', 'lamp', 'Có một cái đèn.'),
	(248, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+picture&type=2', 'There is a picture.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/picture.webp', 'FLASHCARD', 'picture', 'Có một bức tranh.'),
	(249, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+mat&type=2', 'There is a mat.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/mat.webp', 'FLASHCARD', 'mat', 'Có một cái thảm nhỏ.'),
	(250, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+rug&type=2', 'There is a rug.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/rug.webp', 'FLASHCARD', 'rug', 'Có một cái thảm.'),
	(251, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+box&type=2', 'There is a box.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/box.webp', 'FLASHCARD', 'box', 'Có một cái hộp.'),
	(252, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+door&type=2', 'There is a door.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/door.webp', 'FLASHCARD', 'door', 'Có một cái cửa.'),
	(253, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+window&type=2', 'There is a window.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/window.webp', 'FLASHCARD', 'window', 'Có một cái cửa sổ.'),
	(254, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+wall&type=2', 'There is a wall.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/wall.webp', 'FLASHCARD', 'wall', 'Có một bức tường.'),
	(255, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+bath&type=2', 'There is a bath.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/bath.webp', 'FLASHCARD', 'bath', 'Có một cái bồn tắm.');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(256, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+there&type=2', 'What is there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/lamp.webp', 'QUIZ', 'lamp', 'Có gì ở đó?'),
	(623, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+there&type=2', 'What is there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/picture.webp', 'QUIZ', 'picture', 'Có gì ở đó?'),
	(624, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+there&type=2', 'What is there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/mat.webp', 'QUIZ', 'mat', 'Có gì ở đó?'),
	(625, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+there&type=2', 'What is there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/rug.webp', 'QUIZ', 'rug', 'Có gì ở đó?'),
	(626, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+there&type=2', 'What is there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/box.webp', 'QUIZ', 'box', 'Có gì ở đó?'),
	(627, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+there&type=2', 'What is there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/door.webp', 'QUIZ', 'door', 'Có gì ở đó?'),
	(628, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+there&type=2', 'What is there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/window.webp', 'QUIZ', 'window', 'Có gì ở đó?'),
	(629, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+there&type=2', 'What is there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/wall.webp', 'QUIZ', 'wall', 'Có gì ở đó?'),
	(630, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+there&type=2', 'What is there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/bath.webp', 'QUIZ', 'bath', 'Có gì ở đó?');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(257, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+lamp&type=2', 'There is a [lamp].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/lamp.webp', 'FILL_IN_BLANK', 'lamp', 'Có một cái đèn.'),
	(258, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+picture&type=2', 'There is a [picture].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/picture.webp', 'FILL_IN_BLANK', 'picture', 'Có một bức tranh.'),
	(259, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+mat&type=2', 'There is a [mat].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/mat.webp', 'FILL_IN_BLANK', 'mat', 'Có một cái thảm nhỏ.'),
	(260, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+rug&type=2', 'There is a [rug].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/rug.webp', 'FILL_IN_BLANK', 'rug', 'Có một cái thảm.'),
	(261, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+box&type=2', 'There is a [box].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/box.webp', 'FILL_IN_BLANK', 'box', 'Có một cái hộp.'),
	(262, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+door&type=2', 'There is a [door].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/door.webp', 'FILL_IN_BLANK', 'door', 'Có một cái cửa.'),
	(263, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+window&type=2', 'There is a [window].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/window.webp', 'FILL_IN_BLANK', 'window', 'Có một cái cửa sổ.'),
	(264, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+wall&type=2', 'There is a [wall].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/wall.webp', 'FILL_IN_BLANK', 'wall', 'Có một bức tường.'),
	(265, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+a+bath&type=2', 'There is a [bath].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/bath.webp', 'FILL_IN_BLANK', 'bath', 'Có một cái bồn tắm.');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(266, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=It+is+a+television&type=2', 'It is a television.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/television.webp', 'FLASHCARD', 'television', 'Nó là một cái tivi.'),
	(267, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=It+is+a+computer&type=2', 'It is a computer.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/computer.webp', 'FLASHCARD', 'computer', 'Nó là một cái máy tính.'),
	(268, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=It+is+a+phone&type=2', 'It is a phone.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/phone.webp', 'FLASHCARD', 'phone', 'Nó là một cái điện thoại.'),
	(269, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=It+is+a+radio&type=2', 'It is a radio.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/radio.webp', 'FLASHCARD', 'radio', 'Nó là một cái radio.'),
	(270, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=It+is+a+camera&type=2', 'It is a camera.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/camera.webp', 'FLASHCARD', 'camera', 'Nó là một cái máy ảnh.'),
	(271, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=It+is+a+watch&type=2', 'It is a watch.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/watch.webp', 'FLASHCARD', 'watch', 'Nó là một cái đồng hồ đeo tay.'),
	(272, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=It+is+a+clock&type=2', 'It is a clock.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/clock.webp', 'FLASHCARD', 'clock', 'Nó là một cái đồng hồ treo tường.'),
	(273, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=It+is+a+toy&type=2', 'It is a toy.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/toy.webp', 'FLASHCARD', 'toy', 'Nó là một món đồ chơi.'),
	(274, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=It+is+a+doll&type=2', 'It is a doll.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/doll.webp', 'FLASHCARD', 'doll', 'Nó là một con búp bê.');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(275, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+it&type=2', 'What is it?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/television.webp', 'QUIZ', 'television', 'Nó là gì?'),
	(631, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+it&type=2', 'What is it?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/computer.webp', 'QUIZ', 'computer', 'Nó là gì?'),
	(632, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+it&type=2', 'What is it?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/phone.webp', 'QUIZ', 'phone', 'Nó là gì?'),
	(633, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+it&type=2', 'What is it?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/radio.webp', 'QUIZ', 'radio', 'Nó là gì?'),
	(634, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+it&type=2', 'What is it?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/camera.webp', 'QUIZ', 'camera', 'Nó là gì?'),
	(635, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+it&type=2', 'What is it?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/watch.webp', 'QUIZ', 'watch', 'Nó là gì?'),
	(636, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+it&type=2', 'What is it?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/clock.webp', 'QUIZ', 'clock', 'Nó là gì?'),
	(637, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+it&type=2', 'What is it?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/toy.webp', 'QUIZ', 'toy', 'Nó là gì?'),
	(638, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+is+it&type=2', 'What is it?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/doll.webp', 'QUIZ', 'doll', 'Nó là gì?');

INSERT INTO `sessions` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `badge_id`, `description`, `order_index`, `session_type`, `status`, `title`, `part_id`) VALUES
	(85, NOW(), NULL, b'0', NOW(), NULL, NULL, 'Review electronics vocabulary with games!', 5, 'GAMIFIED_REVIEW', 'LOCK', 'Electronics Adventure', 18);

INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(276, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=It+is+a+television&type=2', 'It is a [television].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/television.webp', 'FILL_IN_BLANK', 'television', 'Nó là một cái tivi.'),
	(277, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=It+is+a+computer&type=2', 'It is a [computer].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/computer.webp', 'FILL_IN_BLANK', 'computer', 'Nó là một cái máy tính.'),
	(278, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=It+is+a+phone&type=2', 'It is a [phone].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/phone.webp', 'FILL_IN_BLANK', 'phone', 'Nó là một cái điện thoại.'),
	(279, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=It+is+a+radio&type=2', 'It is a [radio].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/radio.webp', 'FILL_IN_BLANK', 'radio', 'Nó là một cái radio.'),
	(280, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=It+is+a+camera&type=2', 'It is a [camera].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/camera.webp', 'FILL_IN_BLANK', 'camera', 'Nó là một cái máy ảnh.'),
	(281, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=It+is+a+watch&type=2', 'It is a [watch].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/watch.webp', 'FILL_IN_BLANK', 'watch', 'Nó là một cái đồng hồ đeo tay.'),
	(282, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=It+is+a+clock&type=2', 'It is a [clock].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/clock.webp', 'FILL_IN_BLANK', 'clock', 'Nó là một cái đồng hồ treo tường.'),
	(283, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=It+is+a+toy&type=2', 'It is a [toy].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/toy.webp', 'FILL_IN_BLANK', 'toy', 'Nó là một món đồ chơi.'),
	(284, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=It+is+a+doll&type=2', 'It is a [doll].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/doll.webp', 'FILL_IN_BLANK', 'doll', 'Nó là một con búp bê.');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(285, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+one+ball&type=2', 'There is one ball.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/one.webp', 'FLASHCARD', 'one', 'Có một quả bóng.'),
	(286, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+are+two+balls&type=2', 'There are two balls.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/two.webp', 'FLASHCARD', 'two', 'Có hai quả bóng.'),
	(287, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+are+three+balls&type=2', 'There are three balls.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/three.webp', 'FLASHCARD', 'three', 'Có ba quả bóng.'),
	(288, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+are+four+balls&type=2', 'There are four balls.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/four.webp', 'FLASHCARD', 'four', 'Có bốn quả bóng.'),
	(289, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+are+five+balls&type=2', 'There are five balls.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/five.webp', 'FLASHCARD', 'five', 'Có năm quả bóng.'),
	(290, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+are+six+balls&type=2', 'There are six balls.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/six.webp', 'FLASHCARD', 'six', 'Có sáu quả bóng.'),
	(291, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+are+seven+balls&type=2', 'There are seven balls.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/seven.webp', 'FLASHCARD', 'seven', 'Có bảy quả bóng.'),
	(292, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+are+eight+balls&type=2', 'There are eight balls.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/eight.webp', 'FLASHCARD', 'eight', 'Có tám quả bóng.'),
	(293, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+are+nine+balls&type=2', 'There are nine balls.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/nine.webp', 'FLASHCARD', 'nine', 'Có chín quả bóng.'),
	(294, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+are+ten+balls&type=2', 'There are ten balls.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/ten.webp', 'FLASHCARD', 'ten', 'Có mười quả bóng.');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(295, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=How+many+balls+are+there&type=2', 'How many balls are there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/one.webp', 'QUIZ', 'one', 'Có bao nhiêu quả bóng?'),
	(639, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=How+many+balls+are+there&type=2', 'How many balls are there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/two.webp', 'QUIZ', 'two', 'Có bao nhiêu quả bóng?'),
	(640, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=How+many+balls+are+there&type=2', 'How many balls are there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/three.webp', 'QUIZ', 'three', 'Có bao nhiêu quả bóng?'),
	(641, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=How+many+balls+are+there&type=2', 'How many balls are there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/four.webp', 'QUIZ', 'four', 'Có bao nhiêu quả bóng?'),
	(642, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=How+many+balls+are+there&type=2', 'How many balls are there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/five.webp', 'QUIZ', 'five', 'Có bao nhiêu quả bóng?'),
	(643, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=How+many+balls+are+there&type=2', 'How many balls are there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/six.webp', 'QUIZ', 'six', 'Có bao nhiêu quả bóng?'),
	(644, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=How+many+balls+are+there&type=2', 'How many balls are there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/seven.webp', 'QUIZ', 'seven', 'Có bao nhiêu quả bóng?'),
	(645, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=How+many+balls+are+there&type=2', 'How many balls are there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/eight.webp', 'QUIZ', 'eight', 'Có bao nhiêu quả bóng?'),
	(646, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=How+many+balls+are+there&type=2', 'How many balls are there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/nine.webp', 'QUIZ', 'nine', 'Có bao nhiêu quả bóng?'),
	(647, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=How+many+balls+are+there&type=2', 'How many balls are there?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/ten.webp', 'QUIZ', 'ten', 'Có bao nhiêu quả bóng?');

INSERT INTO `sessions` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `badge_id`, `description`, `order_index`, `session_type`, `status`, `title`, `part_id`) VALUES
	(90, NOW(), NULL, b'0', NOW(), NULL, NULL, 'Review numbers 1-10 with games!', 5, 'GAMIFIED_REVIEW', 'LOCK', 'Numbers Adventure 1-10', 19);

INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(296, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+is+one+ball&type=2', 'There is [one] ball.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/one.webp', 'FILL_IN_BLANK', 'one', 'Có một quả bóng.'),
	(297, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+are+two+balls&type=2', 'There are [two] balls.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/two.webp', 'FILL_IN_BLANK', 'two', 'Có hai quả bóng.'),
	(298, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+are+three+balls&type=2', 'There are [three] balls.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/three.webp', 'FILL_IN_BLANK', 'three', 'Có ba quả bóng.'),
	(299, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+are+four+balls&type=2', 'There are [four] balls.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/four.webp', 'FILL_IN_BLANK', 'four', 'Có bốn quả bóng.'),
	(300, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+are+five+balls&type=2', 'There are [five] balls.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/five.webp', 'FILL_IN_BLANK', 'five', 'Có năm quả bóng.'),
	(301, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+are+six+balls&type=2', 'There are [six] balls.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/six.webp', 'FILL_IN_BLANK', 'six', 'Có sáu quả bóng.'),
	(302, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+are+seven+balls&type=2', 'There are [seven] balls.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/seven.webp', 'FILL_IN_BLANK', 'seven', 'Có bảy quả bóng.'),
	(303, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+are+eight+balls&type=2', 'There are [eight] balls.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/eight.webp', 'FILL_IN_BLANK', 'eight', 'Có tám quả bóng.'),
	(304, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+are+nine+balls&type=2', 'There are [nine] balls.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/nine.webp', 'FILL_IN_BLANK', 'nine', 'Có chín quả bóng.'),
	(305, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=There+are+ten+balls&type=2', 'There are [ten] balls.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/ten.webp', 'FILL_IN_BLANK', 'ten', 'Có mười quả bóng.');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(327, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+an+apple&type=2', 'I eat an apple.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/apple.webp', 'FLASHCARD', 'apple', 'Tôi ăn một quả táo.'),
	(328, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+a+banana&type=2', 'I eat a banana.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/banana.webp', 'FLASHCARD', 'banana', 'Tôi ăn một quả chuối.'),
	(329, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+an+orange&type=2', 'I eat an orange.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/orange.webp', 'FLASHCARD', 'orange', 'Tôi ăn một quả cam.'),
	(330, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+a+lemon&type=2', 'I eat a lemon.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/lemon.webp', 'FLASHCARD', 'lemon', 'Tôi ăn một quả chanh.'),
	(331, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+a+grape&type=2', 'I eat a grape.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/grape.webp', 'FLASHCARD', 'grape', 'Tôi ăn một quả nho.'),
	(332, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+a+pear&type=2', 'I eat a pear.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/pear.webp', 'FLASHCARD', 'pear', 'Tôi ăn một quả lê.'),
	(333, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+a+mango&type=2', 'I eat a mango.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/mango.webp', 'FLASHCARD', 'mango', 'Tôi ăn một quả xoài.'),
	(334, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+a+pineapple&type=2', 'I eat a pineapple.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/pineapple.webp', 'FLASHCARD', 'pineapple', 'Tôi ăn một quả dứa.'),
	(335, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+a+watermelon&type=2', 'I eat a watermelon.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/watermelon.webp', 'FLASHCARD', 'watermelon', 'Tôi ăn một quả dưa hấu.'),
	(336, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+a+coconut&type=2', 'I eat a coconut.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/coconut.webp', 'FLASHCARD', 'coconut', 'Tôi ăn một quả dừa.');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(337, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+fruit+do+you+eat&type=2', 'What fruit do you eat?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/apple.webp', 'QUIZ', 'apple', 'Bạn ăn trái cây gì?'),
	(657, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+fruit+do+you+eat&type=2', 'What fruit do you eat?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/banana.webp', 'QUIZ', 'banana', 'Bạn ăn trái cây gì?'),
	(658, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+fruit+do+you+eat&type=2', 'What fruit do you eat?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/orange.webp', 'QUIZ', 'orange', 'Bạn ăn trái cây gì?'),
	(659, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+fruit+do+you+eat&type=2', 'What fruit do you eat?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/lemon.webp', 'QUIZ', 'lemon', 'Bạn ăn trái cây gì?'),
	(660, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+fruit+do+you+eat&type=2', 'What fruit do you eat?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/grape.webp', 'QUIZ', 'grape', 'Bạn ăn trái cây gì?'),
	(661, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+fruit+do+you+eat&type=2', 'What fruit do you eat?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/pear.webp', 'QUIZ', 'pear', 'Bạn ăn trái cây gì?'),
	(662, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+fruit+do+you+eat&type=2', 'What fruit do you eat?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/mango.webp', 'QUIZ', 'mango', 'Bạn ăn trái cây gì?'),
	(663, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+fruit+do+you+eat&type=2', 'What fruit do you eat?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/pineapple.webp', 'QUIZ', 'pineapple', 'Bạn ăn trái cây gì?'),
	(664, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+fruit+do+you+eat&type=2', 'What fruit do you eat?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/watermelon.webp', 'QUIZ', 'watermelon', 'Bạn ăn trái cây gì?'),
	(665, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+fruit+do+you+eat&type=2', 'What fruit do you eat?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/coconut.webp', 'QUIZ', 'coconut', 'Bạn ăn trái cây gì?');

INSERT INTO `sessions` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `badge_id`, `description`, `order_index`, `session_type`, `status`, `title`, `part_id`) VALUES
	(100, NOW(), NULL, b'0', NOW(), NULL, NULL, 'Review fruit vocabulary with games!', 5, 'GAMIFIED_REVIEW', 'LOCK', 'Fruit Adventure 1', 21);

INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(338, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+an+apple&type=2', 'I eat an [apple].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/apple.webp', 'FILL_IN_BLANK', 'apple', 'Tôi ăn một quả táo.'),
	(339, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+a+banana&type=2', 'I eat a [banana].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/banana.webp', 'FILL_IN_BLANK', 'banana', 'Tôi ăn một quả chuối.'),
	(340, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+an+orange&type=2', 'I eat an [orange].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/orange.webp', 'FILL_IN_BLANK', 'orange', 'Tôi ăn một quả cam.'),
	(341, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+a+lemon&type=2', 'I eat a [lemon].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/lemon.webp', 'FILL_IN_BLANK', 'lemon', 'Tôi ăn một quả chanh.'),
	(342, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+a+grape&type=2', 'I eat a [grape].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/grape.webp', 'FILL_IN_BLANK', 'grape', 'Tôi ăn một quả nho.'),
	(343, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+a+pear&type=2', 'I eat a [pear].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/pear.webp', 'FILL_IN_BLANK', 'pear', 'Tôi ăn một quả lê.'),
	(344, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+a+mango&type=2', 'I eat a [mango].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/mango.webp', 'FILL_IN_BLANK', 'mango', 'Tôi ăn một quả xoài.'),
	(345, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+a+pineapple&type=2', 'I eat a [pineapple].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/pineapple.webp', 'FILL_IN_BLANK', 'pineapple', 'Tôi ăn một quả dứa.'),
	(346, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+a+watermelon&type=2', 'I eat a [watermelon].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/watermelon.webp', 'FILL_IN_BLANK', 'watermelon', 'Tôi ăn một quả dưa hấu.'),
	(347, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+a+coconut&type=2', 'I eat a [coconut].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/coconut.webp', 'FILL_IN_BLANK', 'coconut', 'Tôi ăn một quả dừa.');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(348, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+would+like+a+kiwi&type=2', 'I would like a kiwi.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/kiwi.webp', 'FLASHCARD', 'kiwi', 'Tôi muốn một quả kiwi.'),
	(349, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+would+like+a+lime&type=2', 'I would like a lime.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/lime.webp', 'FLASHCARD', 'lime', 'Tôi muốn một quả chanh xanh.'),
	(350, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+would+like+a+tomato&type=2', 'I would like a tomato.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/tomato.webp', 'FLASHCARD', 'tomato', 'Tôi muốn một quả cà chua.'),
	(351, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+would+like+a+carrot&type=2', 'I would like a carrot.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/carrot.webp', 'FLASHCARD', 'carrot', 'Tôi muốn một củ cà rốt.'),
	(352, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+would+like+an+onion&type=2', 'I would like an onion.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/onion.webp', 'FLASHCARD', 'onion', 'Tôi muốn một củ hành.'),
	(353, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+would+like+a+pea&type=2', 'I would like a pea.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/pea.webp', 'FLASHCARD', 'pea', 'Tôi muốn một hạt đậu.'),
	(354, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+would+like+a+bean&type=2', 'I would like a bean.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/bean.webp', 'FLASHCARD', 'bean', 'Tôi muốn một hạt đậu.'),
	(355, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+would+like+a+potato&type=2', 'I would like a potato.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/potato.webp', 'FLASHCARD', 'potato', 'Tôi muốn một củ khoai tây.');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(356, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+would+you+like&type=2', 'What would you like?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/kiwi.webp', 'QUIZ', 'kiwi', 'Bạn muốn gì?'),
	(666, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+would+you+like&type=2', 'What would you like?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/lime.webp', 'QUIZ', 'lime', 'Bạn muốn gì?'),
	(667, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+would+you+like&type=2', 'What would you like?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/tomato.webp', 'QUIZ', 'tomato', 'Bạn muốn gì?'),
	(668, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+would+you+like&type=2', 'What would you like?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/carrot.webp', 'QUIZ', 'carrot', 'Bạn muốn gì?'),
	(669, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+would+you+like&type=2', 'What would you like?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/onion.webp', 'QUIZ', 'onion', 'Bạn muốn gì?'),
	(670, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+would+you+like&type=2', 'What would you like?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/pea.webp', 'QUIZ', 'pea', 'Bạn muốn gì?'),
	(671, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+would+you+like&type=2', 'What would you like?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/bean.webp', 'QUIZ', 'bean', 'Bạn muốn gì?'),
	(672, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+would+you+like&type=2', 'What would you like?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/potato.webp', 'QUIZ', 'potato', 'Bạn muốn gì?');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(357, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+would+like+a+kiwi&type=2', 'I would like a [kiwi].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/kiwi.webp', 'FILL_IN_BLANK', 'kiwi', 'Tôi muốn một quả kiwi.'),
	(358, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+would+like+a+lime&type=2', 'I would like a [lime].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/lime.webp', 'FILL_IN_BLANK', 'lime', 'Tôi muốn một quả chanh xanh.'),
	(359, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+would+like+a+tomato&type=2', 'I would like a [tomato].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/tomato.webp', 'FILL_IN_BLANK', 'tomato', 'Tôi muốn một quả cà chua.'),
	(360, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+would+like+a+carrot&type=2', 'I would like a [carrot].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/carrot.webp', 'FILL_IN_BLANK', 'carrot', 'Tôi muốn một củ cà rốt.'),
	(361, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+would+like+an+onion&type=2', 'I would like an [onion].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/onion.webp', 'FILL_IN_BLANK', 'onion', 'Tôi muốn một củ hành.'),
	(362, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+would+like+a+pea&type=2', 'I would like a [pea].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/pea.webp', 'FILL_IN_BLANK', 'pea', 'Tôi muốn một hạt đậu.'),
	(363, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+would+like+a+bean&type=2', 'I would like a [bean].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/bean.webp', 'FILL_IN_BLANK', 'bean', 'Tôi muốn một hạt đậu.'),
	(364, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+would+like+a+potato&type=2', 'I would like a [potato].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/potato.webp', 'FILL_IN_BLANK', 'potato', 'Tôi muốn một củ khoai tây.');
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	...
	(371, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+fish+for+lunch&type=2', 'I eat fish for lunch.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/fish.webp', 'FLASHCARD', 'fish', 'Tôi ăn cá vào bữa trưa.'),
	...
	(374, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+chicken+for+dinner&type=2', 'I eat chicken for dinner.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/chicken.webp', 'FLASHCARD', 'chicken', 'Tôi ăn thịt gà vào bữa tối.'),
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	...
	(679, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+do+you+eat+for+breakfast&type=2', 'What do you eat for breakfast?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/fish.webp', 'QUIZ', 'fish', 'Bạn ăn gì vào bữa sáng?'),
	...
	(682, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+do+you+eat+for+breakfast&type=2', 'What do you eat for breakfast?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/chicken.webp', 'QUIZ', 'chicken', 'Bạn ăn gì vào bữa sáng?'),
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	...
	(386, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+fish+for+lunch&type=2', 'I eat [fish] for lunch.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/fish.webp', 'FILL_IN_BLANK', 'fish', 'Tôi ăn cá vào bữa trưa.'),
	...
	(389, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+eat+chicken+for+dinner&type=2', 'I eat [chicken] for dinner.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/chicken.webp', 'FILL_IN_BLANK', 'chicken', 'Tôi ăn thịt gà vào bữa tối.'),
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	...
	(419, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+can+play+football&type=2', 'I can play football.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/football.webp', 'FLASHCARD', 'football', 'Tôi có thể chơi bóng đá.'),
	(420, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+can+play+hockey&type=2', 'I can play hockey.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/hockey.webp', 'FLASHCARD', 'hockey', 'Tôi có thể chơi khúc côn cầu.'),
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(427, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+sports+do+you+play&type=2', 'What sports do you play?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/football.webp', 'QUIZ', 'football', 'Bạn chơi môn thể thao nào?'),
	...
	(699, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+sports+do+you+play&type=2', 'What sports do you play?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/hockey.webp', 'QUIZ', 'hockey', 'Bạn chơi môn thể thao nào?'),
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	...
	(432, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+can+play+football&type=2', 'I can play [football].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/football.webp', 'FILL_IN_BLANK', 'football', 'Tôi có thể chơi bóng đá.'),
	(433, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+can+play+hockey&type=2', 'I can play [hockey].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/hockey.webp', 'FILL_IN_BLANK', 'hockey', 'Tôi có thể chơi khúc côn cầu.'),
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(494, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+watch+television&type=2', 'I watch television.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/television.webp', 'FLASHCARD', 'television', 'Tôi xem tivi.'),
	...
	(496, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+listen+to+the+radio&type=2', 'I listen to the radio.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/radio.webp', 'FLASHCARD', 'radio', 'Tôi nghe đài.'),
	(497, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+watch&type=2', 'I watch.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/watch.webp', 'FLASHCARD', 'watch', 'Tôi xem.'),
	(498, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+use+a+camera+to+take+a+photo&type=2', 'I use a camera to take a photo.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/camera.webp', 'FLASHCARD', 'camera', 'Tôi dùng máy ảnh để chụp ảnh.'),
	...
	(500, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+play+with+a+toy+and+doll&type=2', 'I play with a toy and doll.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/toy.webp', 'FLASHCARD', 'toy', 'Tôi chơi với đồ chơi và búp bê.'),
	(501, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+play+with+a+toy+and+doll&type=2', 'I play with a toy and doll.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/doll.webp', 'FLASHCARD', 'doll', 'Tôi chơi với đồ chơi và búp bê.'),
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(506, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+do+you+like+doing&type=2', 'What do you like doing?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/television.webp', 'QUIZ', 'television', 'Bạn thích làm gì?'),
	...
	(731, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+do+you+like+doing&type=2', 'What do you like doing?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/radio.webp', 'QUIZ', 'radio', 'Bạn thích làm gì?'),
	(732, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+do+you+like+doing&type=2', 'What do you like doing?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/watch.webp', 'QUIZ', 'watch', 'Bạn thích làm gì?'),
	(733, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+do+you+like+doing&type=2', 'What do you like doing?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/camera.webp', 'QUIZ', 'camera', 'Bạn thích làm gì?'),
	...
	(735, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+do+you+like+doing&type=2', 'What do you like doing?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/toy.webp', 'QUIZ', 'toy', 'Bạn thích làm gì?'),
	(736, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=What+do+you+like+doing&type=2', 'What do you like doing?', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/doll.webp', 'QUIZ', 'doll', 'Bạn thích làm gì?'),
...
INSERT INTO `session_items` (`id`, `create_at`, `create_by`, `is_delete`, `update_at`, `update_by`, `audio_url`, `content_text`, `image_url`, `item_type`, `keyword`, `translation`) VALUES
	(507, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+watch+television&type=2', 'I watch [television].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/television.webp', 'FILL_IN_BLANK', 'television', 'Tôi xem tivi.'),
	...
	(509, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+listen+to+the+radio&type=2', 'I listen to the [radio].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/radio.webp', 'FILL_IN_BLANK', 'radio', 'Tôi nghe đài.'),
	(510, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+watch&type=2', 'I [watch].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/watch.webp', 'FILL_IN_BLANK', 'watch', 'Tôi xem.'),
	(511, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+use+a+camera+to+take+a+photo&type=2', 'I use a [camera] to take a photo.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/camera.webp', 'FILL_IN_BLANK', 'camera', 'Tôi dùng máy ảnh để chụp ảnh.'),
	...
	(513, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+play+with+a+toy+and+doll&type=2', 'I play with a [toy] and doll.', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/toy.webp', 'FILL_IN_BLANK', 'toy', 'Tôi chơi với đồ chơi và búp bê.'),
	(514, NOW(), NULL, b'0', NOW(), NULL, 'https://dict.youdao.com/dictvoice?audio=I+play+with+a+toy+and+doll&type=2', 'I play with a toy and [doll].', 'https://minhchau-22662231-bucket.s3.ap-southeast-1.amazonaws.com/session-items/doll.webp', 'FILL_IN_BLANK', 'doll', 'Tôi chơi với đồ chơi và búp bê.'),
